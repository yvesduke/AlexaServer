...
//var mySkill = require('.../apps/test-skill/index'); 
//var Crestroncommand1 = mySkill.value1;
	...
	self.load_apps = function(app_dir,root) {
		...
		app_directories(app_dir).forEach(function(dir) {
			...
			try {
				...
				//var crestroncommand = "Apple Tv";
				//var tagline = "Sky Sports";
				var mySkill = require('../../apps/test-skill/index.js');
                //var Crestroncommand1 = mySkill.available;
				var Crestroncommand1 = mySkill.request.slot('InputType');
				//var Crestroncommand1 = x;
					...
					self.express.get(endpoint,function(req,res) {
						if (typeof req.param('schema')!="undefined") {
							...
							res.render('test',{
								...
								"intents":app.intents,
								"Crestroncommand1":Crestroncommand1
						});
